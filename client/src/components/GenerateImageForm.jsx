...
const GenerateImageForm = ({
  ...
  const generateImageFun = async () => {
    ...
    await GenerateAIImage({ prompt: post.prompt })
      ...
      .catch((error) => {
        console.error("GenerateAIImage Error:", error); // Log the entire error object
        setError(error?.response?.data?.error?.message || error?.message); // Display the specific OpenAI error
        setGenerateImageLoading(false);
      });
  };
